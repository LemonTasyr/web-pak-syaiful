...
<section class="jumbotron text-center">
            <img src="{{ asset('image\WhatsApp Image 2023-08-01 at 11.04.44.jpeg') }}" alt="aaa" width="200" class=" rounded-circle img-thumbnail">
            <h1 class="display-4">Dimas Tri Arya Putra</h1>
            <p class="lead">12 RPL 1 | Absen 20</p>
        </section>
